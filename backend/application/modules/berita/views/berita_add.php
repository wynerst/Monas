      ...
      <form action="<?php echo current_url()?>" method="post" role="form" class="form-horizontal" data-validate="parsley">
        ...
        <div class="col-lg-12">              
          <div class="form-group">
            ...
            <div class="col-lg-10">
              <input type="text" id="judul" class="form-control" name="judul" value="<?php echo set_value('judul')?>" data-required="true" />                    
            </div>
          </div>
          <div class="form-group">
            <label for="link" class="col-lg-2 control-label">Berita</label>
            <div class="col-lg-10">
              <textarea id="berita" name="berita" style="width:100%;height:200px;"><?php echo set_value('berita')?></textarea>
            </div>
          </div>
        </div>
