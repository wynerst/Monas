      ...
      <form action="<?php echo current_url()?>" method="post" role="form" class="form-horizontal" data-validate="parsley">
        ...
        <div class="col-lg-10">              
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <input id="tanggal_transfer" type="text" class="form-control date-range" value="<?php echo $result[0]->tgl ?>" name="tanggal_transfer" placeholder="yyyy/mm/dd" data-required="true" />
            </div>
          </div>
          <div class="form-group">
