                        ...
                        <div id="personal" class="tab-pane active">
                          <div class="well well-default">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-lg-8">
                                <input type="text" name="user_login" id="user_login" value="admin" class="form-control" />
                              </div>                      
                            </div>
                            <div class="form-group">
                        ...
                        <div id="contact" class="tab-pane">
                          <div class="well">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-lg-8">
                                <input type="text" name="email" id="email" value="" class="form-control" placeholder="yourname@mail.com" />
                              </div>                      
                            </div>
                          </div>
                        </div>
